  ...
  return (
    <Card shadow={false}>
      <CardBody className={"h-[453px] p-5 flex flex-col justify-center items-center rounded-2xl overflow-hidden bg-no-repeat bg-center bg-cover bg-gray-900 "+extraClass}>
        ...
        <Typography variant="h6" className="mb-4 text-center z-50 text-orange-500" >
          {subTitle}
        </Typography>
        ...
        <Typography
          color="white"
          className="mt-2 mb-10 text-sm md:text-normal w-full lg:w-8/12 text-center font-normal z-50"
        >
          {description}
        </Typography>
      </CardBody>
